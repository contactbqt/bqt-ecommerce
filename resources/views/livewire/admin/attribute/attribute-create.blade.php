<div>
    <flux:modal.trigger name="create-attribute">
        <flux:button variant="ghost" icon:variant="solid" icon="plus">Create Attribute</flux:button>
    </flux:modal.trigger>

    <flux:modal name="create-attribute" variant="flyout" class="md:w-320" style="padding: 0px !important">
        <div class="model-head">
            <flux:heading size="xl" class="font-bold text-purple">Create a New Attribute</flux:heading>
            <flux:text class="mt-2 text-purple">Create a attribute record.</flux:text>
        </div>
        <div class="space-y-6 p-8">
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    <flux:fieldset>
                        ...
                        <flux:checkbox wire:model="is_variant" value="1" label="Use for Variants (Affects Product Price/ Stock)" />
                        <flux:checkbox wire:model="is_filter" value="1" label="Use for Filter (Left Sidebar of Shop Page)" />
                    </flux:fieldset>
                </div>
                <flux:fieldset>
            ...
            <div class="flex">
                <flux:spacer />
                <flux:button wire:click="createAttribute" type="submit" variant="primary" color="sky" wire:loading.attr="disabled" wire:target="createAttribute">
                    <span wire:loading.remove wire:target="createAttribute">Save changes</span>
                    <span wire:loading wire:target="createAttribute">Saving...</span>
                </flux:button>
            </div>
